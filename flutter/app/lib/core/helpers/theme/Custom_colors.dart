...
class ColorsManager {
  ...
  static const Color muted = Color(0xFF818181);
  static const Color destructive = Color(0xFFE0453A);
  static const Color success = Color(0xFF059669);
  static const Color pending = Color(0xFFFACC15);
  static const Color warning = Color(0xFFDB6502);
